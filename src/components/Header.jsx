...
const Header = ({ cart }) => {
    ...
    return (
        <div className='lg:flex lg:justify-around flex justify-between items-center px-3 p-2'>
            ...
            {menuOpen && (
                <div className='flex flex-col border  absolute top-8 right-3 z-50 bg-white text-center '>
                    ...
                    <hr></hr>
                    <NavLink onClick={() => setMenuOpen(!menuOpen)} className="px-3 py-2 hover:bg-gray-200" to='/cart' >Cart {cart.length}</NavLink>
                </div>
            )}
        </div>
    )
